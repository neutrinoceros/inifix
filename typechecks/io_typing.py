...
assert_type(c2_1, Config_SectionsAllowed_ScalarsForbidden)
...
assert_type(c2_2, Config_SectionsForbidden_ScalarsAllowed)
...
assert_type(c2_3, Config_SectionsForbidden_ScalarsForbidden)
...
assert_type(c2_4, Config_SectionsRequired_ScalarsAllowed)
...
assert_type(c2_5, Config_SectionsRequired_ScalarsForbidden)
